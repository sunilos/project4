<%@page import="com.sunilos.pro4.model.FacultyModel"%>
<%@page import="com.sunilos.pro4.bean.FacultyBean"%>
<%@page import="com.sunilos.pro4.util.HTMLUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="com.sunilos.pro4.controller.FacultyListCtl"%>
...
<jsp:useBean id="bean" class="com.sunilos.pro4.bean.FacultyBean" scope="request"></jsp:useBean>
<jsp:useBean id="colbean" class="com.sunilos.pro4.bean.CollegeBean" scope="request"></jsp:useBean>
<jsp:useBean id="corbean" class="com.sunilos.pro4.bean.CourseBean" scope="request"></jsp:useBean>
