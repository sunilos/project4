  ...
  <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
    ...
    <form action="<%=ORSView.COLLEGE_LIST_CTL%>" method="POST">
      ...
      <div class="p-3 bg-light border-bottom d-flex flex-wrap gap-2 align-items-center">
        ...
        <input type="text" name="city" class="form-control form-control-sm" style="max-width:180px;"
               placeholder="Search by City" value="<%=ServletUtility.getParameter("city", request)%>">
