...
public class UserReportCtl extends HttpServlet {

    private static final Logger log = Logger.getLogger(UserReportCtl.class);
    private static final String COMPILED_REPORT_KEY = "USER_LIST_COMPILED_REPORT";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log.error("User report generation failed", e);
            throw new ServletException("Failed to generate user report: " + e.getMessage(), e);
        }
    }
    ...
    private JasperReport getCompiledReport() throws Exception {
        ...
        InputStream jrxml = getClass().getResourceAsStream("/reports/UserListReport.jrxml");
        if (jrxml == null) throw new IllegalStateException("Report template not found: /reports/UserListReport.jrxml");
